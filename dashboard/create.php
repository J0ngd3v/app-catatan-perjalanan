              ...
              <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-12">
                        <div class="card-body">
                          <form action="../Controller/proses_tambah.php" method="POST" enctype="multipart/form-data">
                          <div class="form-group mt-2">
                                <label style="font-weight:bold" for="judul" class="form-label">judul</label>
                          ...
                          <div class="form-group mt-2">
                              ...
                              <input required class="form-control" type="time" name="jam" id="jam">
                            </div>
                            <div class="form-group mt-2">
                                <label style="font-weight:bold" for="lokasi" class="form-label">Lokasi</label>
                                <input required class="form-control" type="text" name="lokasi" id="lokasi">
                            </div>
                            <div class="form-group mt-2">
                            ...
                            <div class="form-group mt-2">
                              ...
                              <input required class="form-control" type="number" name="suhu" id="suhu">
                            </div>
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group mt-2">
                                <button name="submit" class="btn btn-primary" >Tambah Catatan</button>
                            </div>
                        </form>
                        </div>
                    </div>
...
<!-- Pesan Sweet -->
<?php if(isset($_SESSION['kondisi'])){?>
    <script>
         swal("Success", "<?=$_SESSION['kondisi']?>", "success");
    </script>
<?php unset($_SESSION['kondisi']);} ?>
<?php if(isset($_SESSION['gagal'])){?>
    <script>
         swal("Upload File jpg/png!", "<?=$_SESSION['gagal']?>", "error");
    </script>
