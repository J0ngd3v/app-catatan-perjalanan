  ...
  <body style="background-color:#01DEBD;">
    ...
    <div class="container-fluid">
        <div class="card" style="height:100vh !important;">
            ...
            <!-- Bagian Content -->
        <div class="container pt-3  d-flex" style="justify-content:center;align-items:center;height:100vh;width:100%;">
        <div class="alert alert-primary "  role="alert">
           <h4>Selamat Datang <?= $_SESSION['username'] ?></h4><br>
           <p>Ini Merupakan tampilan dashboard dari aplikasi traveling (tugas sekolah pak slamet), yang dimana saya membangun aplikasi ini dengan bahasa php dan framework bootstrap tanpa template.Jadi mohon maaf masih jelek karena baru belajar design. Makasih atas kamu yang bernama <b><?=$_SESSION['username'];?></b> telah mau mencoba apliaksi ini.</p><br>
           <ul>
                <li>PHP Native</li>
                <li>Framework Bootstrap 5</li>
                <li>Niat dan Ketulusan</li>
           </ul>
           <br>
           <p>Dari : Mimin JongDev</p>
        </div>
        </div>
        </div>
    </div>
